...
enable_adv_sim_stats = Setting("enable-adv-sim-stats", False)
...
simulator_adv_position = Setting("simulator-adv-position", (0, 0))
simulator_adv_scale = Setting("simulator-adv-scale", 100)
